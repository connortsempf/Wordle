...
Header::Header(QWidget *parent) : QWidget(parent) {
    ...
    statisticsButton->setIcon(QIcon(":/image-assets/images/statistics-icon.png"));
    ...
    howToPlayButton->setIcon(QIcon(":/image-assets/images/how-to-play-icon.png"));
    ...
    settingsButton->setIcon(QIcon(":/image-assets/images/settings-icon.png"));
    ...
    connect(&ColorTheme::instance(), &ColorTheme::themeChanged, this, [this, title, statisticsButton, howToPlayButton, settingsButton, divider]() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if      (i == 0) closeButtonOriginal = QPixmap(":/image-assets/images/statistics-icon.png");
            else if (i == 1) closeButtonOriginal = QPixmap(":/image-assets/images/how-to-play-icon.png");
            else if (i == 2) closeButtonOriginal = QPixmap(":/image-assets/images/settings-icon.png");
